...
3. **Resumen del Modulo 5:** Este MOC consta de dos lecciones de las cuales solo haremos una:
...
2. Navega a **[Repository Root]\Allfiles\Mod05\Democode**, y luego abre el archivo **BaseConstructors.sln**.
...
2. Observe que la clase **Beverage** contiene un constructor por defecto y un constructor alternativo.
3. En **Solution Explorer**, haga doble clic en **Coffee.cs** y revise el contenido de la clase.
4. Tengan en cuenta que la clase de **Coffee** hereda de la clase de **Beverage**.
5. Observe que la clase **Coffee** contiene un constructor por defecto y un constructor alternativo.
...
8. Observe que la clase **Programa** crea dos instancias del tipo **Coffee**: una usando el constructor por defecto, y otra usando el constructor alternativo.
...
- La representación visual a la respuesta del último ejercicio se muestra en la siguiente imagen:
 ...
 ![alt text](./Images/Fig-2-F11.jpg "Step into Coffee class !!!")

11. Presione F11. Observe que el depurador pasa al constructor por defecto para la clase **Coffee**.

- La representación visual a la respuesta del último ejercicio se muestra en la siguiente imagen:

 ![alt text](./Images/Fig-3-CoffeeConstructor.jpg "Step into Coffee constructor !!!")

12. Presiona F11. Observe que el depurador entra en el constructor por defecto para la clase **Beverage**.

- La representación visual a la respuesta del último ejercicio se muestra en la siguiente imagen:

 ![alt text](./Images/Fig-4-BeverageConstructor.jpg "Step into Beverage constructor !!!")

13. Observe que los constructores de clases derivadas llaman implícitamente al constructor de la clase base por defecto, a menos que especifique un constructor de clase base alternativo.
14. Presiona F11 seis veces, hasta que el depurador vuelva al constructor por defecto de la clase **Coffee**.
     >**Nota:** Si aparece la ventana de **Microsoft Visual Studio**, presione **No** y continúe con F11.

- La representación visual a la respuesta del último ejercicio se muestra en la siguiente imagen:

 ![alt text](./Images/Fig-5-F11sixTimes.jpg "Presionando F11 seis veces !!!")

15. Observe que la lógica del constructor de la clase base se ejecuta antes que la lógica del constructor de la clase derivada.
...
18. Presiona F11. Observe que el depurador entra en el constructor alternativo para la clase **Coffee**.
19. Presiona F11. Observe que el depurador entra en el constructor alternativo para la clase **Beverage**.

- La representación visual a la respuesta del último ejercicio se muestra en la siguiente imagen:

 ![alt text](./Images/Fig-6-SpecialCoffeeConstructor.jpg "Coffee special constructor !!!")


20. Coloca el ratón sobre los parámetros del constructor **Beverage** y señala que el constructor **Coffee** ha pasado valores de argumento a este constructor.
21. Presiona F11 seis veces, hasta que el depurador vuelva al constructor alternativo para la clase **Coffee**.
22. Presiona F11 seis veces, hasta que el depurador vuelva a la clase **Programa**.

- La representación visual a la respuesta del último ejercicio se muestra en la siguiente imagen:

 ![alt text](./Images/Fig-8-BackInProgram.jpg "Regreso al programa principal !!!")
...
- La representación visual a la respuesta del último ejercicio se muestra en la siguiente imagen:
 ...
 ![alt text](./Images/Fig-1-cmd.jpg "Ejecutando el código program.cs !!!")
...
1. Abre la solución **GradesPrototype.sln** de la carpeta **[Repository Root]\Allfiles\Mod05\Labfiles\Solution\Exercise 3**.
