...
13. En el cuadro de texto **Nombre del servidor**, escriba **(localdb)\MSSQLLocalDB**, en la lista **Seleccione o introduzca un nombre de base de datos**, haga clic en **CuartoCafé**, y luego haga clic en **OK**.
